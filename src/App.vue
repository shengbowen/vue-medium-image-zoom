  ...
  <div id="app" class="container">
    ...
    <div>
      <ImageZoom
        ...
        :zoomImage="{
          src: require('./assets/bridge-big.jpg'),
          alt: 'Golden Gate Bridge',
    ...
    <div>
      <ImageZoom
        :defaultImage="{
          src: require('./assets/gazelle.jpg'),
          alt: 'Gazelle Stomping',
          title: 'Dont exceed original image dimensions...',
          className: 'img',
          style: {
            width: '80%'
          }
...
const bigsrc = require('./assets/bridge-big.jpg');
